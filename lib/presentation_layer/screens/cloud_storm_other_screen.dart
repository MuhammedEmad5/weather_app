...
import 'package:weather_app/business_logic_layer/weather_cubit/weather_cubit.dart';
import 'package:weather_app/business_logic_layer/weather_cubit/weather_states.dart';
import 'package:weather_app/presentation_layer/widgets/day_of_week.dart';
import 'package:weather_app/shared/constant/app_colors.dart';
import 'package:weather_app/shared/constant/app_images.dart';
import 'package:weather_app/shared/constant/app_strings.dart';

class CloudStormAndOtherScreen extends StatelessWidget {
  const CloudStormAndOtherScreen({Key? key}) : super(key: key);
  ...
  BoxDecoration backGroundDecoration() {
    return const BoxDecoration(
      gradient: LinearGradient(
          ...
          colors: [
            AppColors.cloudDeep,
            AppColors.cloudLight,
          ]),
      image: DecorationImage(
          image: AssetImage(AppImages.cloudStormOtherBackGround),
          fit: BoxFit.cover,
